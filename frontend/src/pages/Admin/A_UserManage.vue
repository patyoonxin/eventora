...
const fetchUsers = async () => {
  ...
  try {
    ...
    users.value = data.map((u) => ({
      ...u,
      joined: u.created_at?.split("T")[0] ?? u.created_at?.split(" ")[0] ?? "",
    }));
  } catch (e) {
...
const startEditRole = () => {
  tempRole.value = selectedUser.value.role;
...
const saveRole = async () => {
  try {
    const res = await fetch(
      `${API_BASE}/api/admin/users/${selectedUser.value.id}/role`,
      {
        method: "PUT",
        headers: headers(),
    ...
    if (idx !== -1) {
      users.value[idx].role = tempRole.value;
...
const deleteUser = async () => {
  try {
    const res = await fetch(
      `${API_BASE}/api/admin/users/${userToDelete.value.id}`,
      {
        method: "DELETE",
        headers: headers(),
      },
...
const validateNewUser = () => {
  ...
  if (!newUser.value.email.trim())
    ...
    newUserErrors.value.email = "Invalid email";
    ...
    <div class="list-panel">
      ...
      >
        ...
        <div
          ...
          class="avatar"
          :style="{
            background: `linear-gradient(135deg, ${roleColors[user.role].dot}, #3b82f6)`,
          }"
        >
          {{ initials(user.name) }}
        </div>
        ...
        <div class="drawer">
          ...
          <div class="detail-top">
            ...
            <div
              ...
              class="detail-avatar"
              :style="{
                background: `linear-gradient(135deg, ${roleColors[selectedUser.role].dot}, #3b82f6)`,
              }"
            >
            ...
            >
              <span
                class="badge-dot"
                :style="{ background: roleColors[selectedUser.role].dot }"
              />
          ...
          <div class="info-rows">
            ...
            <div class="info-row">
              ...
              ><span class="info-val">{{ selectedUser.joined }}</span>
            </div>
            <div class="info-row">
          ...
          <div class="section">
            ...
            <div v-if="!editingRole" class="role-view">
              <span
                ...
                >{{ roleLabels[selectedUser.role] }}</span
              >
            ...
            <div v-else class="role-edit">
              ...
              <div class="role-btns">
                <button @click="cancelEditRole" class="btn-sm-ghost">
                  Cancel
                </button>
          ...
          <div class="modal-body">
            <div class="field">
              ...
              <input
                ...
                :class="['field-input', newUserErrors.name && 'err']"
              />
              <p v-if="newUserErrors.name" class="err-msg">
                {{ newUserErrors.name }}
              </p>
            </div>
            <div class="field">
              ...
              <input
                ...
                :class="['field-input', newUserErrors.email && 'err']"
              />
              <p v-if="newUserErrors.email" class="err-msg">
                {{ newUserErrors.email }}
              </p>
            </div>
            <div class="field">
    ...
    <transition name="fade">
      ...
      >
        ...
        <div class="modal modal--sm">
          ...
          <p class="modal-sub" style="text-align: center; margin-bottom: 20px">
            <strong>{{ userToDelete?.name }}</strong> will be permanently
            removed.
          </p>
          <div class="modal-foot">
            <button @click="showDeleteConfirm = false" class="btn-ghost">
              Cancel
            </button>
